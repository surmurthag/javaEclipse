...
public class PClient extends JPanel {
	...
	PClient setControleClient(ControleClient controleClient) {
	...
	protected void actionPrincipale(String code, String nom, String prenom,
		...
		if (!"".equals(code)) {
			controleClient.creer(code, nom, prenom, fidelite, crééLe);
			...
			dateCreation.setValue(Instant.now());
			chckbxCartefidelite.setSelected(false);
